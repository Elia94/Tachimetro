...
float t1, t2 = 0; //Variabili temporali 1 e 2
...
Refresh(page);
delay(15); //andando a 50km/h faccio un giro di ruota ogni 11ms è inutile ripetere più spesso il loop e non rischio di prendere due volte lo stesso passaggio della ruota
